...
pub fn build_feature(feature: &str) {
    let project_root = match _find_project_root() {
        None => {
    ...
    match _add_feature_to_route_file(feature, &route_file_path) {
        None => println!("Failed to add to route file"),
        Some(msg) => println!("{}", msg)
    };

    match _add_feature(feature, &project_root) {
...
fn _find_project_root() -> Option<String> {
...
fn _add_feature(feature_name: &str, root: &str) -> Option<String> {
...
//     }}
// }
fn _add_feature_to_route_file(feature_name: &str, file_path: &str) -> Option<String> {
...
fn _get_enum_values(file_path: &str) -> Result<Vec<String>, std::io::Error> {
...
fn _replace_in_file(file_path: &str, previous_lines: String, new_lines: String) {
